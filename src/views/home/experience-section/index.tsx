              ...
              <div>
                ...
                <div className='mt-4'>
                  <ul>
                    ...
                    <li>
                      <span className='mb-2 flex items-start font-sans text-white/70'>
                        &bull; Review Frontend Developer's code so that it is in
                        accordance with the standards in the project
                      </span>
                    </li>
                    <li>
                      <span className='mb-2 flex items-start font-sans text-white/70'>
                    ...
                    <li>
                      <span className='mb-2 flex items-start font-sans text-white/70'>
                        &bull; Implemented and customized Ant Design components
                        as the UI we used.
                      </span>
                    </li>
                  </ul>
              ...
              <div>
                ...
                <div className='mt-4'>
                  <ul>
                    <li>
                      <span className='mb-2 flex items-start font-sans text-white/70'>
                        &bull; Create several features using NextJS, Zustand as
              ...
              <div>
                ...
                <div className='mt-4'>
                  <ul>
                    ...
                    <li>
                      <span className='mb-2 flex items-start font-sans text-white/70'>
                        &bull; Integration RestAPI that has been created by the
                        backend team
                      </span>
                    </li>
                  </ul>
