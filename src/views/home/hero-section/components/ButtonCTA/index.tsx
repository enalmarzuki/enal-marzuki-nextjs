...
const ButtonCTA: React.FC<ButtonCTAProps> = (props) => {
  return (
    ...
    >
      <button className='group relative flex cursor-pointer items-center justify-center gap-3 overflow-hidden rounded-xl border border-[#6c6c6c] px-4 py-3 backdrop-blur-sm md:w-fit'>
